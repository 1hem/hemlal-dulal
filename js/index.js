...
let cout = 0;
 ...
 let teaval=  document.getElementById("tea-counter-container").innerText
   ...
   let somosa =  document.getElementById("total-somosa").innerHTML = val*somosaPrice
    let  tea =  document.getElementById("total-tea").innerHTML = teaval*  teaPrice;
    let tptal_without =  document.getElementById("total-without-tax").innerHTML = somosa+ tea;
   let vatAmount = 13/100*tptal_without;
    document.getElementById("vat").innerHTML = vatAmount;
       ...
       document.getElementById("grand-total").innerHTML = tptal_without+  tipAmount +  vatAmount
